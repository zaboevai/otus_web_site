...
SECRET_KEY = 'm=j8)nhh*$rkv9@c$g(s_$rm*iabnh$)lh&p9lhu)#gnei!l%b'
...
ROOT_URLCONF = 'otus_web_site.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'online_school/templates')]
        ,
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
NOSE_ARGS = [
    '--with-coverage',
    '--cover-package=otus_web_site, online_school',
]